...
/**
 * Include local definitions and sensitive credentials for Backdrop.
 */
...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://dbuser:dbpassword@localhost/backdrop_db?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://dbuser:dbpassword@localhost/civicrm_db?new_link=true');
  }
}
...
$civicrm_paths['civicrm.files']['path'] = $cms_root . '/files/civicrm';
...
// define( 'CIVICRM_MAIL_LOG', '/home/backdrop/repo/www/files/civicrm/templates_c/mail.log');
// }
