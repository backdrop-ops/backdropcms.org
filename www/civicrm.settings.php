...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://USER:PASS@HOST/DB?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['path'] = '/home/backdrop/repo/www/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://CIVIUSER:CIVIPASS@HOST/CIVIDB?new_link=true');
  }
}
...
$civicrm_root = '/home/backdrop/repo/www/modules/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/backdrop/repo/www/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://backdropcms.org');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'OR6XYZ30YN4rPzDGDMj4BcVEuFVbbEhRaN1oLLMPk');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:CABkPggqWNXJXbbW8DpAZhUodlxwAkzUDMvAowPXkY7BGJ6lyQ');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:tTPZfAyTRTD1q7rM5N6d0ZwtfKSd6wXrxA7S0Y82UZ5TCF3Wrpw');
