...
<article id="node-<?php print $node->nid; ?>" class="<?php print implode(' ', $classes); ?> clearfix"<?php print backdrop_attributes($attributes); ?>>
  ...
  <?php
    ...
    hide($content['links']);
    hide($content['field_bullets']);
  ?>

  <?php if ($view_mode == 'full'): ?>
    <div class="row showcase-details-row content"<?php print backdrop_attributes($content_attributes); ?>>
      <div class="col-md-9">
        <?php
      ...
      <div class="col-md-3">
        <?php
          print render($content['field_bullets']);
        ?>
      </div>
    </div>
    <?php if (!empty($rows_output)): ?>
      <?php print $rows_output; ?>
    <?php endif; ?>
  <?php else: ?>
    <div class="row content"<?php print backdrop_attributes($content_attributes); ?>>
      <?php
        print render($content);
      ?>
    </div>
