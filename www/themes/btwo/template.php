 ...
 */
function btwo_form_user_profile_form_alter(&$form, &$form_state) {
 ...
 */
function btwo_preprocess_page(&$variables) {
  ...
  // Add a class for when the admin bar is present.
 ...
 */
function btwo_preprocess_layout(&$variables) {
 ...
 */
function btwo_preprocess_views_view(&$variables) {
 ...
 */
function btwo_preprocess_views_exposed_form(&$variables) {
 ...
 */
function btwo_preprocess_node(&$variables){
 ...
 */
function btwo_preprocess_book_navigation(&$variables) {
 ...
 */
function btwo_book_prev($book_link) {
 ...
 */
function btwo_book_next($book_link) {
  $flat = book_get_flat_menu($book_link);
  // Remove child pages from next/prev links.
  foreach ($flat as $key => $item) {
    if ($item['depth'] > 2) {
...
function btwo_form_element($variables) {
 ...
 */
function btwo_socialfield_drag_components($variables) {
  $element = $variables['element'];
 ...
 */
function btwo_menu_link(array $variables) {
  $element = $variables['element'];
  $sub_menu = '';
 ...
 */
function btwo_on_the_web_image($variables) {
 ...
 */
function btwo_github_info($variables) {
