 ...
 */
abstract class entity_plus_views_example_query extends views_plugin_query {
   ...
   * EntityPlusFieldHandlerHelper::construct_property_selector() and
   * EntityPlusFieldHandlerHelper::extract_property_multiple() can be used to do
   * this.
   *
   * @param $results
   ...
   *
   * @see EntityPlusFieldHandlerHelper::extract_property_multiple()
   */
