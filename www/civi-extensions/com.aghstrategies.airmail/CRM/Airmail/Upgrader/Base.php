 ...
 */
class CRM_Airmail_Upgrader_Base {

  /**
   * @var CRM_Airmail_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Airmail_Upgrader(
        'com.aghstrategies.airmail',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Airmail_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Airmail_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
